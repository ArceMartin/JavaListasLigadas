...
public class Main {
	...
	public static void pruebasEliminaPosicion() {
		...
		lista = new ListaSimple<>(valores2);
		System.out.println(lista);
	...
	public static void pruebasOrdena() {
		...
		ListaSimple<Integer> lista2 = new ListaSimple<>(enteros);
