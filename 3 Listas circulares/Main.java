...
public class Main {
	...
	private static ListaCircular<String> lista;
	...
	public static void pruebasEliminaPosicion() {
		...
		lista = new ListaCircular<>(valores2);
		System.out.println(lista);
	...
	public static void pruebasOrdena() {
		...
		ListaCircular<Integer> lista2 = new ListaCircular<>(enteros);
